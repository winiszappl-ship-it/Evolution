...
Żaden licznik nie odlicza organizmowi czasu. Ginie się z pustego zapasu energii
albo z rozbitego ciała — zawsze z tego, co się właśnie dzieje, a nie z tego, ile
już trwa. Zasiana przez gracza komórka może więc dożyć końca świata.
...
- ciało przeżywa utratę części komórek, ale martwa komórka przestaje pracować:
  organizm traci tyle trawienia, magazynu czy siły, ile zginęło tkanki
...
rozkłada się na minerały — i tam obieg się urywa, bo nikt nie umie ich użyć. Wymieranie w jednym
