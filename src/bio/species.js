...
export class Species {
  constructor(id, genome, tick, parent = null) {
    ...
    this.dietFrac = { photo: 0, absorb: 0, plant: 0, carrion: 0, predation: 0 };
  ...
  dominantDiet() {
    ...
    const labels = {
      photo: 'fotosyntetyk', absorb: 'osmotrof', plant: 'zjadacz materii roślinnej',
    ...
    for (const o of organisms) {
      ...
      if (!s._acc) {
        s._acc = {
          ...
          d: { photo: 0, absorb: 0, plant: 0, carrion: 0, predation: 0 }, dn: 0, troph: new Map(),
